...
class_name MeleeEnemyEVILtest

var baseSpeed: float = 50.0
var obstacleSlowMultiplier: float = 0.65
var slowRecoveryRate: float = 5.5
var detourDistance: float = 500.0
var detourDuration: float = 1
var detectionRadius: float = 200.0
var wanderSpeedMultiplier: float = 0.45
var wanderDirectionMinTime: float = 1
var wanderDirectionMaxTime: float = 2
var health: int = 100
