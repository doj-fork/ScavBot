...
@onready var play_button: Button = $UIRoot/CenterContainer/VBoxContainer/GridContainer/PlayButton
@onready var credits_button: Button = $UIRoot/CenterContainer/VBoxContainer/GridContainer/CreditsButton
@onready var quit_button: Button = $UIRoot/CenterContainer/VBoxContainer/GridContainer/QuitButton
...
@onready var options_button: Button = $UIRoot/CenterContainer/VBoxContainer/GridContainer/OptionsButton
